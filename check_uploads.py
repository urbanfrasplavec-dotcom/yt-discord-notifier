#!/usr/bin/env python3
"""
Checks a list of YouTube channels' RSS feeds for new uploads and posts
a notification to a Discord webhook when a new video is found.

No YouTube API key required — uses YouTube's public per-channel RSS feed:
    https://www.youtube.com/feeds/videos.xml?channel_id=<CHANNEL_ID>

State (the last video seen per channel) is persisted to seen.json so the
script only announces videos it hasn't announced before.
"""
...
CHANNELS = {
    ...
    "UCvYPobTo42NM36X7VC4dLhA": "FlameFrags",
    "UCPLMPHT-d8GZOqL_AHJFdQQ": "Parrot",
}
