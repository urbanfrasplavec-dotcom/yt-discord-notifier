#!/usr/bin/env python3
"""
Checks a third list of YouTube channels' RSS feeds for new uploads and posts
a notification to a (different) Discord webhook when a new video is found.

Sibling to check_uploads.py / check_uploads_2.py — same logic, separate
channel list, separate state file, and separate Discord webhook secret.
"""
...
STATE_FILE = "seen_3.json"

CHANNELS = {
    "UCPYZ-R5LQGMeU7QikgxmH8Q": "DrDonut",
    "UCldCI5K_HmwS_iQX7xqIlPg": "DrDonut Clips",
    "UC4_JC2KVJLZwnXkZhsPWmDg": "Yellow Donutt",
    "UCSx6vsVfEjHKevahvODzJGQ": "clipsdonut",
    "UCu7uM73mvdncmVZ6OCDuTnA": "DonutToo",
    "UCX9hffZ6aLnqk27KDiiIJEg": "NotDonut",
    "UCCTha469iyN8KBPy2QBCX5w": "DrDonutShorts",
}

DISCORD_WEBHOOK_URL = os.environ.get("DISCORD_WEBHOOK_URL_3")
...
def notify_discord(video, friendly_name):
    if not DISCORD_WEBHOOK_URL:
        print("WARNING: DISCORD_WEBHOOK_URL_3 not set, skipping notification.")
        return
